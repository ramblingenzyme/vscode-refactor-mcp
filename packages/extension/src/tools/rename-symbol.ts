...
export const renameSymbolTool: Tool = {
  ...
  description: {
    description:
      "Rename a symbol (function, class, variable) and update all references",
    inputSchema,
    examples: [
      {
    ...
    notes:
      "Locates the symbol in the specified file and renames all references across the workspace",
  },
