...
import { VSCodeRequest, VSCodeResponse, VSCodeCommand } from '../../../shared/dist/protocol';
    ...
    async start(): Promise<string> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.server.listen(this.socketPath, () => {
                ...
                const outputChannel = vscode.window.createOutputChannel("VSCode MCP Proxy");
                outputChannel.appendLine(`IPC Server listening on: ${this.socketPath}`);
                outputChannel.appendLine(`To connect manually: export VSCODE_MCP_SOCKET_PATH=${this.socketPath}`);
